...
public final class MathContext implements Serializable {
    ...
    public MathContext(String val) {
        ...
        try { // any error here is a string format problem
            ...
            final int fence = val.indexOf(' ');    // could be -1
            ...
            off = fence + 1 + 13;
            final String str = val.substring(off, val.length());
    ...
    private void readObject(java.io.ObjectInputStream s)
        ...
        if (precision < MIN_DIGITS) {
            final String message = "MathContext: invalid digits in stream";
            throw new java.io.StreamCorruptedException(message);
        }
        if (roundingMode == null) {
            final String message = "MathContext: null roundingMode in stream";
            throw new java.io.StreamCorruptedException(message);
        }
    }
